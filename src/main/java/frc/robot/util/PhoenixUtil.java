...
public class PhoenixUtil {
    ...
    public static SwerveModuleConstants regulateModuleConstantForSimulation(
        ...
        return moduleConstants
                ...
                // Adjust drive motor PID gains for simulation
                .withDriveMotorGains(
                        new Slot0Configs()
                                .withKP(DriveConstants.driveSimP)
                                .withKI(0)
                                .withKD(DriveConstants.driveSimD)
                                .withKS(DriveConstants.driveSimKs)
                                .withKV(DriveConstants.driveSimKv)
                                .withKA(0)
                ...
                .withSteerMotorGains(
                        new Slot0Configs()
                                ...
                                .withKS(DriveConstants.turnSimKs)
                                .withKV(DriveConstants.turnSimKv)
                                .withKA(0)
                                .withStaticFeedforwardSign(
                                        StaticFeedforwardSignValue.UseClosedLoopSign))
                ...
                .withDriveInertia(DriveConstants.driveInertia);
    }
}
