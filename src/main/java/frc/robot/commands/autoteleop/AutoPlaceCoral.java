...
public class AutoPlaceCoral extends SequentialCommandGroup {
    public AutoPlaceCoral(AlignmentConfig config, Level level, CoralPivot coralPivot, GroundIntakePivot groundIntakePivot, Elevator elevator) throws FileVersionException, IOException, ParseException {
